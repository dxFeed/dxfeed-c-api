...
void DX_RECORD_FIELD_GETTER_NAME(dx_time_and_sale_t, sequence) (void* object, void* field) {
    *(dxf_int_t*)field = (dxf_int_t)(((dx_time_and_sale_t*)object)->event_id & 0x00000000FFFFFFFFL);
}

void DX_RECORD_FIELD_GETTER_NAME(dx_time_and_sale_t, exch_sale_conds) (void* object, void* field) {
