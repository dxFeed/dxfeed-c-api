...
static const dx_field_info_t dx_fields_trade[] = {
	...
	{ dx_fid_compact_int | dx_fid_flag_decimal, L"Last.Flags",        DX_RECORD_FIELD_STDOPS(dx_trade_t, flags),         dx_ft_common_field },
...
static const dx_field_info_t dx_fields_greeks[] = {
    ...
    { dx_fid_compact_int | dx_fid_flag_decimal,  L"Greeks.Price", DX_RECORD_FIELD_STDOPS(dx_greeks_t, greeks_price), dx_ft_common_field },
