...
#define DX_VER_LEGAL_COPYRIGHT   "Copyright (C) 2010-2025 Devexperts LLC"
#define DX_VER_PRODUCT_NAME      "dxFeed C API framework"

#define DX_LIBRARY_VERSION L"DXFeed.cpp v 9.0.0 (c) Devexperts LLC"
