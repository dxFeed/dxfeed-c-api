...
//const dxf_long_t WideDecimal::Consts::MIN_SIGNIFICAND = rightShift(std::numeric_limits<dxf_long_t>::min(), 8);
const dxf_long_t WideDecimal::Consts::MIN_SIGNIFICAND = 0xFF80000000000000LL;
//const dxf_long_t WideDecimal::Consts::MAX_SIGNIFICAND = rightShift(std::numeric_limits<dxf_long_t>::max(), 8);
const dxf_long_t WideDecimal::Consts::MAX_SIGNIFICAND = 0x007FFFFFFFFFFFFFLL;
