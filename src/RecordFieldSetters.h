...
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_trade_t, trade_id)
...
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_trade_t, day_id)
...
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_profile_t, high_price_52)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_profile_t, low_price_52)
...
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_order_t, action_time)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_order_t, order_id)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_order_t, aux_order_id)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_order_t, price)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_order_t, size)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_order_t, executed_size)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_order_t, count)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_order_t, flags)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_order_t, trade_id)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_order_t, trade_price)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_order_t, trade_size)
...
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_time_and_sale_t, trade_id)
...
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_spread_order_t, time_nanos)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_spread_order_t, action_time)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_spread_order_t, order_id)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_spread_order_t, aux_order_id)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_spread_order_t, price)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_spread_order_t, size)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_spread_order_t, executed_size)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_spread_order_t, count)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_spread_order_t, flags)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_spread_order_t, trade_id)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_spread_order_t, trade_price)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_spread_order_t, trade_size)
...
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_series_t, call_volume)
DX_RECORD_FIELD_STDOPS_PROTOTYPES(dx_series_t, put_volume)
